...
Для того что бы доказать, что наша программа не завершится в случае брошенного исключения в тестах, мы изменим код в *TestCase*:
