<!--
title: Кластеризация Docker контейнеров с помощью Consul
date: 2016/05/29
id: 0f0dc5ca-c233-41c0-a266-5ed0ef24fc76
...
labels:
  ...
  - VirtualBox
-->
Разработка микросервисов может оказаться не простой задачей. Есть инструменты которые помогут упростить себе задачу.
